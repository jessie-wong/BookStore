	...
	<div id="content">
		<div id="content-left">
			<div id="detailsdetails">
				...
				<div class="gray">
					<img src="/resources/images/bullet1.gif">
					${goods.goodsname}
				</div>
				<div class="item">
					<div class="item-left">
					...
					<div class="item-right">
						...
						<div class="box_center">
							...
							<p class="details">
								<span class="special_icon"><img src="/resources/images/chaozhi.png"
									alt="" title=""> </span>
			...
			<div class="addtocart"><a href="/cart/addCart?goodsid=${goods.goodsid}"class="addtocart"> <img src="/resources/images/addtocart.png"></a>
			</div>
		</div>
