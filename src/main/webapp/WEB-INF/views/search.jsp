...
<%
	...
	int _pageRow = goodsBeanHandler.getGoodsBeanCountByName(bookname);
	int _pageCount = _pageRow % _pageSize == 0 ? _pageRow / _pageSize : _pageRow / _pageSize + 1;
	if (__page != null) {
		_page = Integer.parseInt(__page);
	}
	ArrayList<GoodsBean> arr = goodsBeanHandler.getGoodsBeanByNameByPage(_page, _pageSize, bookname);
%>
